...
Lis :
1. `docs/narration/equipe/memoire-science.md` — validations déjà faites, refs enregistrées
2. `docs/narration/equipe/sources-sciences.md` — documentaires et refs de référence
...
Après chaque validation, ajoute une ligne dans `docs/narration/equipe/memoire-science.md` :
