...
3. Format pack : skill [`lunii-pack-builder`](../skills/lunii-pack-builder/SKILL.md) (story.json v1, controlSettings, binaire FS).

## Images Lunii (côté dino)

- Production : skill [`dino-images-lunii`](../skills/dino-images-lunii/SKILL.md). Charte 🔒 : [`studio/dino/figees/encyclopedie.md`](../../studio/dino/figees/encyclopedie.md) § IMAGES LUNII.
