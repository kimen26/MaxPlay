...
> Source de vérité : [`studio/minijeux/pmo/INVARIANTS.md`](../../studio/minijeux/pmo/INVARIANTS.md) + skill global [`.claude/skills/maxplay-tiles/LESSONS.md`](../skills/maxplay-tiles/LESSONS.md) (30+ leçons gravées).
...
- Leçons : [`.claude/skills/maxplay-tiles/LESSONS.md`](../skills/maxplay-tiles/LESSONS.md)
