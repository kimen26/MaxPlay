...
const BEBE = {
  ...
  saurolophus: "petite pointe osseuse qui prolonge l'arrière du crâne vers le haut, bec de canard",
  ...
  hatzegopteryx: "grosse tête au bec massif sans dents, cou court et épais, ailes de peau repliées, fin duvet",
  ...
  edaphosaurus: "voile sur le dos hérissée de petites barres transversales, toute petite tête, pattes écartées de lézard",
