...
| HO-MJ-01 | Pôle JEU : mémoire convergente | 2 | `studio/minijeux/**` sauf `tests/`, `docs/handoffs/` | en cours |
...
| HO-NAR-01 | Pôle NARRATION : mémoire convergente | 2 | `studio/narration/**` sauf `stories/`, `scripts/`, `docs/handoffs/` | en cours |
