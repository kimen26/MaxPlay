...
| Stack | HTML vanilla · `game-html/js/` partagé · GitHub Pages |
...
1. **Bus** : toujours `busSVG()` / `busSVGHiddenNum()` de [`game-html/js/bus-svg.js`](../../game-html/js/bus-svg.js). Jamais d'emoji 🚌, jamais de div CSS colorée.
2. **Couleurs** : toujours depuis [`game-html/js/data.js`](../../game-html/js/data.js) → `LIGNES`. Jamais de hex hardcodé.
...
├── /mj-XX.html    ← HTML vanilla (source: game-html/)
