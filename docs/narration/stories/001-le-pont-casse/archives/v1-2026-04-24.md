...
**Statut :** V1 complète — texte réimporté 2026-04-26 · comité de lecture fait (session 2026-04-13) · V2 à faire (3 modifications prioritaires — voir Notes narratives)
...
## Texte — V1 (prénoms originaux : Léo→Wex, Élia→Melki, Sam→Juju)
...
## Intégration univers (options)

L'histoire telle qu'elle existe (version réaliste, sans magie) fonctionne parfaitement dans l'univers post-Éveil. **Règle rappelée :** univers IMPLICITE — les noms-concepts ne sont pas prononcés dans le texte.

**Option A — Touches légères (recommandée pour les premières histoires)**
- Les arbres autour du pont font un son très doux quand le pont est réparé — presque rien, juste une vibration.
- Le compagnon de Juju se détasse / s'éclaircit quand la planche est posée (forme exacte à trancher — voir `univers/compagnons.md`).
- Ferretti a peut-être été un "réparateur" dans sa jeunesse (pas dit, juste suggéré par sa façon de se tenir).

**Option B — Touches moyennes**
- La planche en frêne "voulait" être posée là — Melki le ressent sans pouvoir l'expliquer.
- La petite fille qui traverse est accompagnée d'une forme (compagnon) qui gambade sur le pont le premier matin.

**Option C — Immersion complète** *(à éviter pour les premières histoires — contrevient à la règle "univers implicite")*
- Le pont cassé est dans un lieu qui "sent" les frictions non résolues.
- Juju voit une vieille peur du quartier rétrécir quand le pont est réparé.

**Recommandation :** Option A. Les touches doivent être quasi-invisibles — on les remarque à la 3e lecture, pas à la 1ère.
...
### Retours comité de lecture (session 2026-04-13)

**7 profils internes** (éditeur Gallimard, prof français, prof philo, Boo 4 ans, enfant 8 ans, père, mère) + **8 cultures** (🇺🇸 🇩🇪 🇨🇳 🇳🇬 🇯🇵 🇲🇦 🇧🇷 🇷🇺).

**Ce qui fonctionne (consensus) :**
- La scène avec Ferretti est le moment fort, unanimement identifié
- "Pas tout le monde." — meilleure réplique du texte (toutes cultures)
- "Elle ne sut jamais pourquoi il était réparé." — phrase forte, plusieurs lecteurs s'y arrêtent
- La répartition des rôles Wex/Juju/Melki est lisible sans être étiquetée

**3 modifications prioritaires pour V2 :**
1. **Supprimer la chute en italique** — remplacer par la dernière image de la petite qui traverse (5 lecteurs sur 7 la rejettent)
2. **Donner à Melki un tort réel** — elle pense à vérifier la propriété mais ne le fait pas, et s'en tire trop proprement. Un regret franc la rendrait plus humaine
3. **Ralentir le retournement de Wex** — de "on peut juste sauter" à "d'accord" en deux répliques, c'est trop rapide. Ajouter un battement (image concrète de la petite fille, ou silence)
