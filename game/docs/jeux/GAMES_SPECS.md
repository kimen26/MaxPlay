...
- **Bus SVG** : `busSVG()` ou `busSVGHiddenNum()` de `site/js/bus-svg.js`. Jamais de SVG inline, jamais d'emoji, jamais de div CSS colorée.
...
**Fichier** : `site/mj-08.html` (numéro 7 dans le menu, fichier nommé mj-08)
...
**Fichier** : `site/mj-07.html` (splash intro) + `game/` (Phaser app, build → `mj-07/`)
...
Toujours depuis `site/js/data.js` → tableau `LIGNES`.
