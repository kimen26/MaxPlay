...
const DINO_FAMILLES = [
  { id: 'trex',       label: 'Les chasseurs à deux pattes', savant: 'les théropodes',          emoji: '🦖', desc: 'Ils marchent sur deux pattes et chassent',  color: '#c0392b', bg: 'linear-gradient(135deg,#7b0000,#c0392b)',
    explic: 'Théro veut dire bête sauvage, et pode veut dire pied. On les a appelés comme ça parce qu\'ils marchaient sur deux grandes pattes arrière, comme les oiseaux d\'aujourd\'hui — pas sur quatre ! Presque tous mangeaient de la viande. Les plus connus : le T-Rex, le Spinosaure, le Giganotosaure.' },
  { id: 'cou_long',   label: 'Les géants à long cou',       savant: 'les sauropodes',          emoji: '🦒', desc: 'Le cou immense pour manger tout en haut',   color: '#27ae60', bg: 'linear-gradient(135deg,#0a4a1e,#27ae60)',
    explic: 'Sauro veut dire lézard, et pode veut dire pied. Ce sont les plus grands animaux qui ont marché sur Terre ! Quatre pattes comme des poteaux, un cou immense pour attraper les feuilles tout en haut des arbres. Ils mangeaient seulement des plantes. Les stars : le Diplodocus, le Brachiosaure, le Brontosaure.' },
  { id: 'arme',       label: 'Les armures à pics',          savant: 'les thyréophores',        emoji: '🦴', desc: 'Plaques, piques et queue-massue',           color: '#7f8c8d', bg: 'linear-gradient(135deg,#2c3e50,#7f8c8d)',
    explic: 'Thyréo veut dire bouclier, et phore veut dire porter : les porteurs de bouclier. Leur dos était couvert de plaques, de piques et d\'os durs comme une armure pour se protéger des chasseurs. Ils broutaient les plantes. Les connus : le Stégosaure, avec des plaques sur le dos, et l\'Ankylosaure, avec une grosse boule osseuse au bout de la queue.' },
  { id: 'cornu',      label: 'Les cornus à collerette',     savant: 'les cératopsiens',        emoji: '🛡️', desc: 'Des cornes et une grande collerette',      color: '#f39c12', bg: 'linear-gradient(135deg,#7a5000,#f39c12)',
    explic: 'Cérat veut dire corne, et ops veut dire face : les faces à cornes. Ils avaient des cornes sur la tête et une grande collerette d\'os derrière le crâne, comme un bouclier autour du cou. Ils mangeaient des plantes. La super-star : le Tricératops et son cousin le Torosaure.' },
  { id: 'bec',        label: 'Les becs de canard',          savant: 'les ornithopodes',        emoji: '🦆', desc: 'Un bec plat et de grands troupeaux',        color: '#8e44ad', bg: 'linear-gradient(135deg,#4a0080,#8e44ad)',
    explic: 'Ornitho veut dire oiseau, et pode veut dire pied : les pieds d\'oiseau. Leurs pattes ressemblaient à celles des oiseaux. Ils avaient un large bec plat comme un canard pour brouter, et vivaient en grands troupeaux. Tous mangeaient des plantes. Les connus : le Parasaurolophus et l\'Iguanodon.' },
  { id: 'raptor',     label: 'Les chasseurs à griffes',     savant: 'les théropodes à griffes',emoji: '🦅', desc: 'Griffes-faucilles et chasseurs malins',     color: '#e67e22', bg: 'linear-gradient(135deg,#7a3000,#e67e22)',
    explic: 'Comme les théropodes, ils marchaient sur deux pattes, mais ils étaient plus petits, rapides et malins, avec une grande griffe recourbée comme un croissant à chaque pied pour attraper leurs proies. Ils mangeaient de la viande. Les vedettes : le Vélociraptor et le grand Deinonychus.' },
  { id: 'volant',     label: 'Volants & Marins',            savant: 'pas vraiment des dinos !',emoji: '🦋', desc: 'Dans les airs et les mers préhistoriques',  color: '#2980b9', bg: 'linear-gradient(135deg,#003366,#2980b9)',
  ...
  { id: 'bizarre',    label: 'Les inclassables',            savant: 'têtes dures & curiosités',emoji: '🤯', desc: 'Inclassables et super originaux !',         color: '#16a085', bg: 'linear-gradient(135deg,#0a3d30,#16a085)',
    explic: 'Des dinos trop spéciaux pour entrer dans une famille ! Le Pachycéphalosaure — pachy veut dire épais, céphalo veut dire tête, donc tête épaisse — se donnait des coups de crâne comme un bélier. Il mangeait des plantes. Et le Therizinosaurus avait des griffes géantes mais ne mangeait que des feuilles !' },
];
