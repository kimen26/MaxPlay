"""Brique sw05_int_ne — tile Sidewalk_1_5 sur fond asphalt.
...
T = 'roads/ME_Singles_City_Terrains_48x48_Sidewalk_1_5.png'
...
SNIPPET = {'name': 'sw05_int_ne', 'cols': 3, 'rows': 3, 'ground': ground, 'objects': []}
