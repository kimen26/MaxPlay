"""Brique sw07_int_nw — tile Sidewalk_1_7 sur fond asphalt.
...
T = 'roads/ME_Singles_City_Terrains_48x48_Sidewalk_1_7.png'
...
SNIPPET = {'name': 'sw07_int_nw', 'cols': 3, 'rows': 3, 'ground': ground, 'objects': []}
