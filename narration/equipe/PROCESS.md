...
| **Outputs** | <ul><li>13 versions LIBRES : `versions-writers/claude-opus-def.md`, `claude-opus-reco.md`, `claude-sonnet-def.md`, `claude-sonnet-reco.md`, `claude-haiku-def.md`, `claude-haiku-reco.md`, `kimi-def.md`, `kimi-reco.md`, `kimi-thinking.md`, `deepseek-def.md`, `deepseek-reco.md`, `grok-def.md`, `grok-reco.md`</li><li>1 version GUIDÉE : `versions-writers/kimi-guide.md` (axes 1-6 + trame story si fournie via `brief-writer-guide.md`)</li><li>Notes d'intention en fin de chaque fichier (frontmatter + section finale)</li><li>`kanban.md` étape 4 ✅</li></ul> |
| **Casting writers (14, calibration 2026-05-12 → réduction post-3-5 histoires)** | Détail complet (15 colonnes : modèle + thinking + température + top_p + invocation) dans [`../pmo/INVARIANTS.md`](../pmo/INVARIANTS.md) § *Casting writers étape 4*. Tableau résumé : <table><tr><th>#</th><th>Slug</th><th>Température</th><th>Reco créatif source</th></tr><tr><td>1</td><td>claude-opus-def</td><td>défaut Anthropic</td><td>Anthropic</td></tr><tr><td>2</td><td>claude-opus-reco</td><td>1.0 (plafond)</td><td>Anthropic</td></tr><tr><td>3</td><td>claude-sonnet-def</td><td>défaut</td><td>Anthropic</td></tr><tr><td>4</td><td>claude-sonnet-reco</td><td>1.0</td><td>Anthropic</td></tr><tr><td>5</td><td>claude-haiku-def</td><td>défaut</td><td>Anthropic</td></tr><tr><td>6</td><td>claude-haiku-reco</td><td>1.0</td><td>Anthropic</td></tr><tr><td>7</td><td>kimi-def</td><td>0.6 (Instant)</td><td>Moonshot</td></tr><tr><td>8</td><td>kimi-reco</td><td>1.0 + top_p 0.95</td><td>Moonshot</td></tr><tr><td>9</td><td>kimi-thinking</td><td>1.0 fixe</td><td>Moonshot (thinking)</td></tr><tr><td>10</td><td>kimi-guide (GUIDÉ)</td><td>0.6</td><td>Moonshot</td></tr><tr><td>11</td><td>deepseek-def</td><td>défaut (1.0 API = 0.3 modèle)</td><td>DeepSeek</td></tr><tr><td>12</td><td>deepseek-reco</td><td>1.5 (creative writing)</td><td>DeepSeek officiel</td></tr><tr><td>13</td><td>grok-def</td><td>défaut xAI</td><td>xAI</td></tr><tr><td>14</td><td>grok-reco</td><td>1.2 (au-delà 1.5 incohérent)</td><td>xAI</td></tr></table> Détails LLM : [`infra/mcp/MODELS.md`](../../infra/mcp/MODELS.md). Référence températures : [`references/temperatures-llm.md`](references/temperatures-llm.md). |
...
3. **Lire le dernier output produit** :
   ...
   - Étape 3 : `briefs/`
   - Étape 4 : compter `4-versions-writers/` (combien sur 10)
   - Étape 5 : compter `5-lecteurs-temoins/` (combien sur 20 cible, 6 en transitoire pour 001-004) + `synthese-lecteurs.md`
