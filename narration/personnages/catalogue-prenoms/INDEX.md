...
| 4 — Romantique | Jérem | 28 | hébreu, japonais, araméen, mapuche, javanais |
...
| 3 — Performeur | Polo ← Salomon/Solal | Kiran/Ravi/Jaya (sk), Hikari/Taiga (jp), Apollon (gr), Victor (lat), Inti (quechua), Naran/Altan (mongol), Tsehaye (amharique) |
| 4 — Romantique | Jérem ← Jérémie | Lior/Uriel/Ézéchiel (he), Shizuku/Miyu (jp), Psykhe (gr), Talitha/Lyana (araméen), Berhane (amharique), Cahaya/Senja (java), Kallfü (mapuche) |
...
- [../INDEX.md](../INDEX.md) — index personnages global
- [../lookup.yml](../lookup.yml) — table de correspondance personnages
- [../prénoms-brainstorm-cultures.md](../prénoms-brainstorm-cultures.md) — brainstorm initial
- [../prénoms-candidats.md](../prénoms-candidats.md) — anciens candidats
