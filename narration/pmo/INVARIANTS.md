...
?? Le bloc `## Les 4 Writers — angles assignés` de `equipe/ORGANIGRAMME.md` parle de **4 angles narratifs**, pas de 4 writers. C'est un levier de variance, pas une répartition writers.
...
**Gabarit structure** : chaque perso (`type-NN/` ou `wex/`) suit le gabarit figÃ© 5 fichiers (DEC-GABARIT-PERSO-001, 2026-05-15) : README Â· enneagramme Â· personnage Â· alive Â· voix. Source dÃ©tail : [`../personnages/INDEX.md`](../personnages/INDEX.md) Â§ Gabarit figÃ©.
...
| 002 | La La Libellule impossible | ?? **étape 6 sélection en cours** (étapes 0-5 ?, Q-ouvertes ? DEC-TENSION-RESONANCE 2026-05-12, casting Wex+Juju+Nono, panel 20 lecteurs ?, top writers identifiés) | Directeur (arbitrage sélection) |
| 003+ | À démarrer | ? — | — |
