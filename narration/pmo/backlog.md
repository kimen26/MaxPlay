...
| 🟡 | **AUDIO-SCRIPT-V2** | **Script production audio (text-to-dialogue packetisé)** | **Haute** | Auteur + Dev | ✅ **LIVRÉ 2026-05-16 01:40** : `narration/scripts/generate-story-dialogue.js` implémente text-to-dialogue API packetisé. Prochaine action : (1) Tester sur STORY-002 post-étape 10 canon (bloqué par VOIX-001 markup + VOIX-002/003 voice_ids). (2) Documenter findings + itérations dans `pmo/sprint-log.md`. |
