...
| ⚪ | **AUDIO-SCRIPT-V2** | **Créer script production audio v2 (text-to-dialogue packetisé)** | **Haute** | Auteur + Dev | Décision figée DEC-AUDIO-PRODUCTION-001 (2026-05-16). Créer `narration/scripts/generate-story-audio-v2.js` implémentant text-to-dialogue API packetisé < 2000 char par appel. Remplace legacy `generate-story-audio.js` (anti-pattern 32 TTS séparés). Pré-requis : VOIX-001 (voice-director markup) + VOIX-002/003 (voice_ids), puis lancer sur STORY-002 post-étape 10 canon. |
