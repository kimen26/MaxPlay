...
- Le compagnon de Juju se détasse / s'éclaircit quand la planche est posée (forme exacte à trancher — voir `univers/vie-quotidienne/compagnons.md`).
...
- **Wex** dans cette histoire : rôle catalytique (voit, propose, relie) — cohérent avec la piste "Wex observateur" (voir `univers/meta/nom-candidats.md` § Wex World).
