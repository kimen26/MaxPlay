"""Brique sw11_ext_se — tile Sidewalk_1_11 sur fond asphalt.
...
T = 'roads/ME_Singles_City_Terrains_48x48_Sidewalk_1_11.png'
...
SNIPPET = {'name': 'sw11_ext_se', 'cols': 3, 'rows': 3, 'ground': ground, 'objects': []}
