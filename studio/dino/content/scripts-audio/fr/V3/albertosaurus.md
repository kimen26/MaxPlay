...
> Chiffres data (`studio/dino/content/dinos/albertosaurus.json`) : 9.5 m long · 3 m haut · 2 t · vitesse 30 km/h. Comparaisons = sortie EXACTE de _compLong(9.5) / _compHaut(3) / _compPoids(2) / _compVitesse(30), régénérées 2026-09-12 : `aussi long qu'un camion !` / `aussi haut qu'un panier de basket !` / `aussi lourd qu'un rhinocéros !` / `aussi vite qu'un cheval au petit galop !`.
