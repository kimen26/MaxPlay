...
> Chiffres data (`studio/dino/content/dinos/deinonychus.json`) : 3.4 m long · 0.9 m haut · 0.08 t · vitesse 30 km/h. Comparaisons = sortie EXACTE de _compLong(3.4) / _compHaut(0.9) / _compPoids(0.08) / _compVitesse(30), régénérées 2026-09-12 : `comme une petite voiture !` / `aussi grand qu'un enfant de 4 ans !` / `aussi lourd que Papa !` / `aussi vite qu'un cheval au petit galop !`.
