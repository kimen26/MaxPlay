...
> Chiffres data (`studio/dino/content/dinos/kentrosaurus.json`) : 4.5 m long · 1.8 m haut · 1.1 t · vitesse 7 km/h. Comparaisons = sortie EXACTE de _compLong(4.5) / _compHaut(1.8) / _compPoids(1.1) / _compVitesse(7), régénérées 2026-09-12 : `aussi long qu'un grand 4×4 !` / `aussi grand que Papa debout !` / `aussi lourd qu'une petite voiture !` / `comme Papa qui marche vite !`.
