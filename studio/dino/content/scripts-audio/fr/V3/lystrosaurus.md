...
> Chiffres data (`studio/dino/content/dinos/lystrosaurus.json`) : 0.7 m long · 0.35 m haut · 0.017 t · vitesse 5 km/h. Comparaisons = sortie EXACTE de _compLong(0.7) / _compHaut(0.35) / _compPoids(0.017) / _compVitesse(5), régénérées 2026-09-12 : `comme un gros chat allongé !` / `il t'arrivait aux genoux !` / `aussi lourd qu'un enfant de 4 ans !` / `aussi vite que toi quand tu marches !`.
