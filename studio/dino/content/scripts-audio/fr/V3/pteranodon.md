...
> Chiffres data (`studio/dino/content/dinos/pteranodon.json`) : 6 m long · 1.8 m haut · 0.025 t · vitesse 32 km/h. Comparaisons = sortie EXACTE de _compLong(6) / _compHaut(1.8) / _compPoids(0.025) / _compVitesse(32), régénérées 2026-09-12 : `aussi long qu'une rue à deux voies est large — il barrait la route !` / `aussi grand que Papa debout !` / `aussi lourd qu'un chien !` / `aussi vite qu'un cheval au petit galop !`.
