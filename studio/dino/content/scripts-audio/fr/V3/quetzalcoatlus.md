...
> Chiffres data (`studio/dino/content/dinos/quetzalcoatlus.json`) : 11 m long · 5 m haut · 0.2 t · vitesse 90 km/h. Comparaisons = sortie EXACTE de _compLong(11) / _compHaut(5) / _compPoids(0.2) / _compVitesse(90), régénérées 2026-09-12 : `aussi long qu'un bus RATP !` / `presque trois Papas l'un sur l'autre !` / `aussi lourd qu'un lion !` / `presque aussi vite qu'un guépard !`.
