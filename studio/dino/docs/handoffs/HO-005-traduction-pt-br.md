# HO-005 — Traduction Portugais-bresilien (pt-br)
...
Produire `studio/dino/content/i18n/pt-br/strings.json` : les 71 fiches dino et les
11 familles ecrites en Portugais-bresilien natif (Bresil), pour un enfant de 4 ans, destinees a etre ENTENDUES.

## Fichiers autorises

- `studio/dino/content/i18n/pt-br/strings.json` (a creer)
- `studio/dino/content/i18n/pt-br/NOTES.md` (choix de traduction non evidents)
...
```json
{
  "_meta": { "lang": "pt-br", "base": "corpus-fr.json", "date": "2026-09-03" },
...
```bash
node -e "JSON.parse(require('fs').readFileSync('studio/dino/content/i18n/pt-br/strings.json','utf8'))"
node studio/dino/content/scripts/export/_check-traduction.cjs pt-br
```
