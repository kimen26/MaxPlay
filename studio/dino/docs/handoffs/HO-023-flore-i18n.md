...
## Objectif
Traduire les champs texte de `DINO_PLANTES` (name, nom_etym, region, comp_hauteur recalculée en unités cibles, environnement, feuille, graines, mangee_comment, superpower, fait, vivant) selon `_CHARTE-TRADUCTION.md`, ajouter `plantes` au corpus + aux bundles `site/js/gen/i18n/dinos-strings.<lang>.js`.

## Fichiers autorisés
- `content/i18n/_corpus/**`, `content/i18n/<lang>/strings.json`, `content/scripts/export/_extract-corpus-i18n.cjs`, `_gen-strings-bundle.cjs`, `site/js/gen/i18n/dinos-strings.*.js`
