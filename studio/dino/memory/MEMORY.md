...
- **Audit échelle scripts audio FR réécrits (BLOQUANT)** : 32 fiches hors tolérance sur l'échelle de poids suite à une réécriture du 2026-09-03 par une autre session ; régénération des MP3 en retard **non exécutée** tant que ce n'est pas corrigé. Détail : `memory/TODO.md` § Audit échelle.
