...
- **HO-012** [~] — Relecture croisée FR par dino-conseiller : moitié 1 (43 fiches) = 43 PASS / 0 CORRIGER (`rapports/HO-012-relecture-moitie-1.md`) ; moitié 2 (28, théropodes en tête) en cours. Ferme de fait **AUDIT-ECHELLE-FR-32** (les 71 blocs B sont réécrits sur les fonctions exécutées) et **EP-D-AUDIO-DRIFT-COMPPOIDS**.
