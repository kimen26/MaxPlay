...
**Statut batch paléoart Allosaurus/Ceratosaurus/Gallimimus (2026-07-10)** : Les 3 dinos théropodes livrées avec images complètes (5 PNG chacune, hero + 4 scènes). Allosaurus ✅ (9 fichiers : hero + 4 scènes + coloriage + 2 sources), Ceratosaurus ✅ (9 fichiers, regénération Grok 2026-07-05 corne nasale OK), Gallimimus ✅ (9 fichiers, hero présent malgré audit-trail confusion 2026-07-10). Câblage dinos-data.js champ `png:` confirmé. Décision Papa Yann : déploiement immédiat ou validation visuelle d'abord ?
