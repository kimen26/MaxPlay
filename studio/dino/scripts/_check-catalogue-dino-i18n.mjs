...
//
// Usage : node studio/dino/scripts/_check-catalogue-dino-i18n.mjs
// Playwright vit dans studio/minijeux/tests/node_modules (seule install du repo),
// d'où l'import résolu explicitement depuis ce dossier-là.
// Déplacé depuis studio/minijeux/tools/ le 2026-09-12 (HO-R01, réception scripts dino).
...
const require = createRequire(pathToFileURL(resolve(__dir, '../../minijeux/tests/package.json')).href);
