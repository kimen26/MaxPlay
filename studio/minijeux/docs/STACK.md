...
(source, généré depuis le FR par `_extract-mj-regles.mjs`) → pack `site/js/gen/i18n/mj-strings.<lang>.js`
...
| **Bébé** (ajout PY 2026-09-25) | le bébé de l'espèce qui sort de sa coquille, chibi mais réaliste, détouré | `site/img/dinos/bebes/` | `<Nom>_bebe.webp` · montré à l'éclosion du Nid (`js/nid-ui.js`, repli sur la tête) · généré par `batch-dino-bebe.mjs` |
