...
| HO-MJ-20 | L'Armoire v8 · meuble VIDE en kit de pièces DÉCOUPÉES dans la référence (carcasse inpaintée, 5 planches, 2 montants, tiroir, vantaux ouverts/fermés), ouvert/fermé, boîtes générées | site/dev-armoire.html, js/armoire-meuble.js, js/gen/armoire-kit.js, css/armoire-meuble.css, img/armoire/v8/**, tools/armoire-v8.py, armoire-meuble-shot.mjs, armoire-meuble-cmp.py, tests/armoire-meuble.spec.mjs | livré 2026-09-19 (v7 kit GPT rejetée par PY le soir même, refaite en v8 = la référence au pixel, D-030 ; recette PY à faire ; suite HO-MJ-22 = y remettre les cases) |
