...
> ⚠️ **SNAPSHOT 2026-06-01** : les catégories ci-dessous (Compter / Lire / Observer & vite…) sont remplacées par le menu v2 — source vivante [`site/js/catalog.js`](../../../site/js/catalog.js). Purge 2026-08-10 : mj-01, mj-04, mj-05, mj-08, mj-11, mj-12, mj-13b, mj-16, mj-17 (+ d'autres, voir `memory/archive/backlog-fermes-2026.md`) **n'existent plus** — leurs paliers ci-dessous sont conservés comme matière de design (« on garde l'idée »).
>
