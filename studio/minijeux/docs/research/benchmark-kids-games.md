...
**Applicable MaxPlay** : lier au **pôle Narration** — Wex (#7, héros) pourrait apparaître dans le menu et entre les MJ. Voir [`studio/narration/personnages/INDEX.md`](../../../narration/personnages/INDEX.md).
