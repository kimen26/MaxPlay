...
### D-028 – 2026-09-18 · L'armoire arrive FERMÉE, montre douze jeux, et ses tiroirs sont leurs propres boutons
Recette du designer sur la v6 de passe 1. Quatre arbitrages de forme, définitifs. **(1) Portes fermées à l'arrivée, et elles le restent.** La passe 1 les ouvrait toutes seules après 420 ms « pour ne pas demander deux gestes à l'enfant à chaque retour » : ça tuait l'idée même du meuble. On découvre ce qu'il y a dedans en le touchant. **(2) Exactement douze jeux affichés**, six derrière les portes hautes, six derrière les basses — pas treize, pas quinze. Au-delà, l'accueil vire au launcher d'icônes et cesse d'être un meuble. Dinos, Monde et Œufs ne comptent pas dans les douze : ce sont les trois fonctions permanentes, posées dans la niche centrale toujours ouverte. Les 36 jeux du catalogue restent dans l'espace parents. **(3) Les tiroirs SONT les boutons.** Aucune icône flottante par-dessus : la poignée dessinée dans la carcasse dit déjà « ouvre-moi », et les deux icônes posées dessus en passe 1 alourdissaient tout le bas du meuble. Tiroir gauche = l'album Padidi, tiroir droit = « encore », qui retire douze nouveaux jeux au sort sans quitter l'armoire. **(4) Les vantaux s'ouvrent SOUS 90°** (80°), jamais au-delà : passé 90° on regarde le dos de la texture 2D. Pour que l'ouverture reste dégagée malgré cet angle, les charnières sont reportées sur le montant extérieur du meuble (`transform-origin: -23.19%`, mesuré sur la référence) — c'est d'ailleurs ainsi qu'est monté le meuble. Conséquence de forme assumée : un vantail ouvert se voit presque de chant, sa face est assombrie pour qu'il ne se lise pas comme un montant de plus. Complète D-027 (repère fixe), qui reste la décision d'architecture. Brief : `docs/handoffs/HO-MJ-19-armoire-v6-repere-fixe.md` § 4.

### D-029 – 2026-09-19 · L'armoire v7 est recomposée depuis un KIT de pièces (une par nature), toujours dans le repère fixe
Demande Papa Yann : « fabrique cette armoire, déjà juste vide, ouvert / fermé, logique et modulable », avec le kit que ChatGPT a livré le 17/09 (carcasse vide, planche, montant, porte fermée, porte ouverte, tiroir, spot, halo — un seul bois, une seule lumière). Amende le corollaire (1) de D-027 (« trois sprites, pas vingt-cinq ») : on repasse à **une pièce par NATURE, réutilisée** (5 planches = 1 sprite, 2 montants = 1 sprite, 4 vantaux = 2 sprites miroités, 2 tiroirs = 1 sprite), ce que L-137 prescrivait déjà — ce que L-137 interdit, c'est une bande par POSITION, et ça reste interdit. Ce que D-027 garde intact : repère 911 × 1480, tout en pourcentage, mise à l'échelle d'un bloc, zéro handler de resize, zéro contrainte en pixels sur la géométrie, halo en CSS, portes de droite = miroir des gauches, portes fermées à l'arrivée (D-028). Trois règles propres au kit : **(1) la carcasse définit l'ouverture** — sa boîte « ouverture » est mesurée dans le sprite et tout le reste en dérive (largeur et haut/bas des vantaux, bornes des planches), les y des niveaux restant ceux de la référence ; **(2) la configuration est une donnée** (`ArmoireMeuble.DEFAUT`, surchargeable), le JS ne calcule aucune dimension ; **(3) le meuble vit d'abord VIDE sur `site/dev-armoire.html`**, `index.html` reste en v6 jusqu'à validation de Papa Yann — l'intégration des cases est un brief à part (HO-MJ-22). Le sprite « porte ouverte » du kit est peint à un angle plus faible que la référence (≈ 28 % de largeur apparente contre 13,6 %) : il est posé dans une boîte de 13,6 % du repère, compression horizontale assumée, sinon il sort du cadre à 360 px. Brief : `docs/handoffs/HO-MJ-20-armoire-v7-kit-modulaire.md`.

### D-030 – 2026-09-19 · Le kit de l'armoire se découpe dans LA référence, jamais dans des pièces générées séparément
Amende D-029 le jour même. Papa Yann, sur la v7 assemblée depuis les 8 pièces GPT : « les lumières trop visibles en haut et absentes partout ailleurs, les portes ouvertes problématiques, le métal des portes trop de côté, gros problème de profondeur / angle / épaisseur / géométrie, les croisements planches verticales / horizontales n'importe quoi, les tiroirs ne fittent pas ». Tout est vrai et tout a la même cause : chaque pièce GPT est rendue de son propre point de vue avec sa propre lumière (la planche est une dalle vue de dessus, le montant un bâton, le tiroir tiré, le vantail ouvert à un autre angle), donc aucune pose ne peut les faire tenir ensemble — c'est exactement ce que L-136 interdisait déjà. Décision : **le résultat voulu existe, c'est `docs/refs/armoire/ref-ouverte.png` ; le kit en sort par découpe** (`tools/armoire-v8.py`) — carcasse inpaintée (planches, montants, tiroirs et vantaux effacés par miroir des bandes voisines), 5 planches, 2 montants, 1 tiroir, 2 vantaux ouverts (droite = miroir), 2 vantaux fermés découpés dans `ref-fermee.png` AVEC leurs charnières (v6 les coupait à x=195, sans charnière, porte trop étroite). À la configuration par défaut le rendu EST la référence, au pixel ; la modularité vient de ce que chaque pièce est un élément DOM à boîte propre (`js/gen/armoire-kit.js`, généré par le script), qu'on peut masquer, déplacer ou dupliquer. Ce qui reste de D-029 : repère fixe, config = données, tout en pourcentage, zéro pixel, meuble vide validé sur `dev-armoire.html` avant `index.html`. Ce qui est abandonné : le kit GPT (`site/img/armoire/v7/`, `docs/refs/armoire/kit/`, `tools/armoire-kit.py`, supprimés), l'ouverture « avant » mesurée par luminance, l'épaisseur de planche en config, le halo CSS (la lumière est peinte dans la carcasse, dans chaque compartiment, comme sur la référence). Un vantail fermé pivote autour de l'axe réel de ses charnières (2,5 % de sa largeur, mesuré), plus autour d'un point hors boîte.
