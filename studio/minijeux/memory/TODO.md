...
- [?] HO-MJ-17 — livré 2026-09-17 après 4 passes de recette orchestrateur (kit 25 Ko, captures `HO-MJ-17-proto-*.png`), **à valider par PY sur captures** avant HO-MJ-18. Reliquats connus : portes très hors écran sur téléphone (80 % de la porte projetée visible, mais mince), canal bleu du bois à 18 d'écart de la référence, `proto.js` 96 lignes. Armoire v4 : kit de 7 sprites + lumière CSS, **prototype statique** (`tools/armoire-proto/`, sans objets, sans index.html) à valider par PY sur captures avant intégration. Brief `docs/handoffs/HO-MJ-17-armoire-kit-prototype.md`.
- [ ] HO-MJ-18 (après validation du prototype) — intégration v4 dans `site/index.html` : objets en calque, avatar mordu par l'arche, `armoire.spec` refait sur le nouveau modèle, SW precache du kit, retrait des tuiles `carcasse/` et v1 inutilisées.
