...
- **EPIC-I18N-MJ / LOTS 1-2 + t()** [~] — GO PY 2026-09-05 (nuit). HO-MJ-03 : étendre `mj-i18n.js` d'une fonction `MJi18n.t(gameId, cle, frFallback, params)` pour les chaînes hors panneau règle (titres, boutons, toasts, consignes `setConsigne`, `SoundPool.phrase` texte de repli, données courtes) puis traduire en anglais les 12 jeux des lots 1 (mj-24/28/30/31/32) et 2 (mj-06/09/13a/13c/18/21/34). Agent Sonnet en cours.
