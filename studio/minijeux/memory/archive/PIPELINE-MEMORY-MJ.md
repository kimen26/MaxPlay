> **ARCHIVE** — déplacé depuis `site/PIPELINE-MEMORY-MJ.md` le 2026-09-03 (HO-G10, nettoyage prod : ce fichier n'a jamais eu vocation à être déployé, il n'était référencé par aucun code servi à Max). Contenu inchangé, verbatim.
