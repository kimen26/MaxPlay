# Archive — Leçons pôle JEU (rotation 2026-09-12, HO-R02)

> Contenu déplacé VERBATIM depuis `../LESSONS.md` le 2026-09-12 (HO-R02, campagne refonte GED). Numéros L-NNN jamais renumérotés, ordre d'apparition d'origine conservé. Ces leçons restent la trace exacte de ce qui a été appris/décidé à l'époque — ne pas les corriger pour qu'elles "collent" à l'état actuel du code.
