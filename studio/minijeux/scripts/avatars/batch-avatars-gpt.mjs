...
const DINOS=[
 ...
 {id:'anky',name:'Ankylosaure',palette:'gris-vert, vert foncé, beige',sig:'trapu et bas sur pattes, dos bombé couvert de rangées de plaques osseuses et de pointes, queue avec une GROSSE MASSUE ronde bien visible sur le côté'},
 {id:'oeuf',name:'Œuf de dinosaure',palette:'blanc-crème, beige, vert doux (taches)',sig:'gros œuf moucheté, coquille fendillée au sommet, deux grands yeux ronds et un sourire qui dépassent par la fissure entrouverte'},
 {id:'libellule',name:'Libellule géante préhistorique (Méganeura)',palette:'turquoise, bleu foncé, crème (ailes)',sig:'quatre grandes ailes nervurées, long corps segmenté fin, gros yeux ronds, vue de trois quarts'},
 {id:'ammonite',name:'Ammonite',palette:'orange-corail, brun foncé, crème',sig:'coquille en spirale striée bien enroulée, petits tentacules mignons qui dépassent de l’ouverture, grands yeux'},
 {id:'mosa',name:'Mosasaure',palette:'bleu-gris, bleu foncé, crème (ventre)',sig:'grand reptile marin en pose de nage, corps allongé, quatre nageoires-palettes, longue gueule de crocodile, queue à nageoire'},
 {id:'plesio',name:'Plésiosaure',palette:'bleu-vert d’eau, bleu foncé, crème',sig:'reptile marin au TRÈS long cou courbé, petite tête souriante, corps rond, quatre nageoires-palettes'},
 {id:'cory',name:'Corythosaure',palette:'vert-jaune, vert foncé, crème',sig:'crête ronde en demi-cercle comme un casque sur le sommet de la tête (sa signature), bec de canard, bipède'},
 {id:'vague',name:'Grande vague océane',palette:'bleu océan, bleu nuit, blanc (écume)',sig:'grande vague qui s’enroule façon estampe japonaise, crête d’écume avec des doigts d’écume, petit visage rigolo dans la vague'},
 {id:'cendre',name:'Nuage de cendre volcanique',palette:'gris cendre, gris foncé, orange (braises)',sig:'gros nuage bouillonnant de cendre avec un visage rigolo, quelques étincelles-braises orange'},
 {id:'lave',name:'Goutte de lave',palette:'orange-rouge, bordeaux, jaune (cœur)',sig:'petite goutte de lave vivante avec un visage rigolo, coulées fondantes et gouttelettes'},
