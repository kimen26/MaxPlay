...
const DINOS=[
 {id:'tritri',name:'Tricératops',pal:'vert vif, vert foncé, crème (cornes et collerette)',sig:'3 cornes (2 grandes frontales + 1 petite sur le nez), large collerette osseuse derrière la tête, trapu et attachant'},
];
