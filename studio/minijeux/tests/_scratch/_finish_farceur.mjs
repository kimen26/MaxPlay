...
const DINOS=[
 {id:'galli',name:'Gallimimus',pal:'gris-bleu clair, gris-bleu fonce, creme',sig:'silhouette autruche : long cou fin, petite tete a bec sans dents, grandes pattes fines de coureur, longue queue horizontale, bras courts a plumes'},
];
