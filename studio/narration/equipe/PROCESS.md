...
>
> Dernière mise à jour : **2026-07-03** (boucle goût auteur — DEC-BRIEF-CURSEUR, DEC-PANEL-V2, DEC-DUEL-DE-GOUT : **menu d'angles COMMUN à pioche libre déclarée** (même input pour tous — les angles assignés individuellement ont été proposés puis ANNULÉS par Papa Yann le même jour), panel 12 appels hétérogènes, lecture `gout/` obligatoire aux étapes 3 et 6, **casting 14 writers CONFIRMÉ** — Kimi via canal code prioritaire (sert K2.7-Code), modèles rafraîchis Opus 4.8 / Sonnet 5). Précédente : 2026-05-12.
...
> **⚡ 2026-07-03 — vague 5 STORY-002** : **Kimi passe par le canal `kimi-for-coding` (forfait code) en priorité TOUJOURS** (décision Papa Yann 2026-07-03) — ce canal (`api.kimi.com/coding`) sert le **dernier modèle Kimi Code (K2.7-Code depuis 06/2026)**, l'alias suit les évolutions. Le payant K2.6 reste réservé aux 2 writers k26 du casting. **Même input pour TOUS les writers** : brief commun + menu d'angles commun (pioche libre déclarée en note d'intention — voir étape 3). **Longueur identique pour tous** (400-550 mots vague 5) — pas de cible par writer.
> ✅ **Casting 14 CONFIRMÉ par Papa Yann (2026-07-03)** — la réduction à 8 proposée le même jour a été refusée : on garde les 14 (ARCHI-008 reste ouvert pour l'arbitrage après 3-5 histoires). Kimi : 2 writers via canal gratuit `kimi-for-coding` (kimi-reco, kimi-reco-guide) + 2 via payant `kimi-k2.6` (k26-instant, k26-thinking — writers autorisés du casting figé, cf. feedback kimi-payant). **Veille modèles 2026-07-03** : Claude rafraîchi → Opus 4.8 + Sonnet 5 (Haiku 4.5 inchangé) ; Kimi K2.6, DeepSeek v4-pro, Grok 4.3 = toujours les derniers disponibles (K3 et Grok 4.5 non publics ; K2.7-Code = orienté code, non retenu pour l'écriture narrative). Prochaine veille au lancement de chaque nouvelle story.
