...
>
> Dernière mise à jour : **2026-07-03** (boucle goût auteur — DEC-BRIEF-CURSEUR, DEC-PANEL-V2, DEC-DUEL-DE-GOUT : micro-briefs par writer obligatoires, panel 12 appels hétérogènes, lecture `gout/` obligatoire aux étapes 3 et 6, **casting 14 writers CONFIRMÉ par Papa Yann 2026-07-03** — Kimi via canal code prioritaire, modèles rafraîchis Opus 4.8 / Sonnet 5). Précédente : 2026-05-12.
