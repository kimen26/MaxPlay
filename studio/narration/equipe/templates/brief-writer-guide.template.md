...
**Catalogue à utiliser** : [`../../cross-culture/onomatopees/catalogue-onomatopees.md`](../../cross-culture/onomatopees/catalogue-onomatopees.md) — 37 onomatopées validées cross-langues. **Privilégier les pivots 🟢** (universels, lisibles dans 5+ langues) si l'histoire est destinée à voyager. ⚠ « clap clap » = applaudissements UNIQUEMENT, pas de l'eau qui coule.
