# Décisions de fond — PMO Narration (ARCHIVE 2026-H1)

> 🗄️ **Archive 2026-H1** — contenu VERBATIM de `../decisions.md` antérieur au 2026-07-01 (rotation D6 du 2026-07-27). **Ne plus alimenter** : les nouvelles entrées vont dans `../decisions.md`.
...
| Q4 | 2026-05-13 | **Self-challenge — `memoire-architecte.md` non maintenue** | Agent deprecated → mémoire ne reçoit plus de mises à jour. Archive dans `_archive/equipe/` ou laisse dormir ? | narration-pmo (audit 2026-05-13) | ✅ Résolu — archivé 2026-06-14 (`equipe/_archive/`) |
...
**Action :** lancer le PROCESS standard. ~~La V1 reste en `_archive/v1-2026-04-24.md`.~~ ⚠️ *Annoté 2026-07-27 : ce fichier n'a jamais été commité — texte V1 perdu, perte actée par Papa Yann (D3). Ne pas chercher à restaurer.* Idées Papa Yann pour la V2 dans `stories/001-le-pont-casse/lecteurs-temoins/john-relecture-2026-04-30.md`.
...
> ⚠️ **SUPERSEDED sur les lignes T6/T8 uniquement (2026-07-27, DEC-SENSIBILITES-T6-T8)** : la table ci-dessous conserve les valeurs historiques — les valeurs canon sont **Pierrot = Plantes** et **Juju = Animaux** (camp des fiches vivantes). Le reste de la table reste valide.
