...
|--------|-----|-------|----------|---------|------------------|
| 🔴 | **AUDIO-KIMI-PANNE-VAGUE5** | **Investiguer panne socket Kimi (gratuit + payant simultanés 72-97s)** | **CRITIQUE** | Auteur + Dev | Vague 5 STORY-002 : 3 writers Kimi (reco gratuit, reco-guide gratuit, k26-thinking payant) échoués identiquement socket fermé ~72-97s. Gratuit + payant tombent même mur. Cause : payload size prompts > plafond socket passerelle Moonshot. Blocker étape 4 si répète vague 6+. Workaround CLI `infra/mcp/call-llm.mjs` disponible (timeout 600s) non tenté cette reprise. Cible : diagnostic + workaround avant STORY-003. |
| 🔴 | **STORY-002-SELECTION-REFONTE** | **La Libellule impossible — Étape 6 Refonte complète (vague 4 + duel goût REX)** | **CRITIQUE** | Directeur + PMO | 6-selection.md périmé (vague 2). REX duel 2026-07-03 : Papa Yann refuse 2 champions panel (trop longs, dialogues absents/punchline). Refaire : utiliser synthese-lecteurs vague 4 (2026-05-17) comme base + duel REX comme critère sélection. Intention Directeur (DEC-BRIEF-CURSEUR) appliquée. Blocker étape 7 (rewrite). Cible : immédiat. |
