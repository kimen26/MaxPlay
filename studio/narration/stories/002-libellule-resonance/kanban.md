...
| 8 | GateKeeper | GateKeeper | ❌→🟢 | 2026-07-07 | [`8-gatekeeper-verdict.md`](8-gatekeeper-verdict.md) — **1 correction mineure** : Wex sous-doté (1 seule réplique, brief ≥2). Ajout 1 dialogue court. Reste : 23/24 critères ✅. Après correction → PASS automatique. |
