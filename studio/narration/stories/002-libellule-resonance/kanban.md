...
| 4 | **14 Versions writers — VAGUE 5** | 14 Writers | ✅→📦 (écart doc.) | 2026-07-03 | [`4-versions-writers/`](4-versions-writers/) — **11/14 persistées** (6 Claude + kimi-k26-instant + deepseek déf/reco + grok déf/reco). **Longueur RECOMPTÉE 2026-07-03 (reprise) : TOUTES dans 400-550 mots** (haiku-def 428 · haiku-reco 470 · opus-def 507 · opus-reco 499 · sonnet-def 470 · sonnet-reco 476 · deepseek-def 549 · deepseek-reco 497 · grok-def 483 · grok-reco 414 · kimi-k26-instant 528). ⚠️ Les chiffres « hors gabarit » précédents (deepseek-def 588, opus-def 538, kimi 577) étaient FAUX — artefact de comptage (note d'intention titrée `## Note` comptée dans le corps). Aucun resserrement nécessaire. **3 Kimi manquants (kimi-reco, kimi-reco-guide, kimi-k26-thinking) = ÉCART DOCUMENTÉ** : panne infra socket ~72-97s (`ask_kimi` gratuit ET `ask_kimi_payant`), 3 tentatives 2026-07-03 → 3 échecs `socket connection closed unexpectedly`. PROCESS autorise « 14 sauf écart documenté ». Vague 4 archivée `_archive/vague-4/`. |
...
| 5 | **Panel v2 hétérogène (12 calls) + synthèse** | Panel v2 + Directeur | ✅ (écart doc.) | 2026-07-03 | **13 fiches produites** (12 attendues + 1 bonus `G-extra-haiku` session concurrente) : `5-lecteurs-temoins/`. **Kimi indisponible sur les 4 groupes** (même panne socket) → 3e voix substituée par Haiku/DeepSeek (PROCESS panel v2 = « Haiku OU DeepSeek » en 3e colonne). Chaque groupe = Sonnet + Haiku + DeepSeek. **Corpus jugé = 11 versions.** Synthèse consolidée produite : [`5-synthese-lecteurs.md`](5-synthese-lecteurs.md). **Top A** : 1.opus-reco (3.15) · 2.grok-reco (4.15) · 3.haiku-reco · 4.sonnet-reco · 5.deepseek-reco. **Signal central** : kimi-k26-instant polarise (#1-2 chez 5 fiches / dernier chez 7 — voix d'enfant vraie mais fin-pirouette + cascade anonyme). Patterns « à éviter » : main-qui-parle, doigt-qui-pend, libellule-sur-le-genou, fin qui repart. Test calibration one-shot toujours SAUTÉ (ticket TEST-PANEL-CALIBRATION). |
